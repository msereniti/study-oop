...
TTcpServer::TTcpServer(quint16 port) :
    QTcpServer()
{
    listen(QHostAddress::Any,port);
    connect((QTcpServer*)this,SIGNAL(newConnection()),
...
{
    disconnect((QTcpServer*)this,SIGNAL(newConnection()),
            this,SLOT(connection()));
    foreach (QTcpSocket* socket, clients)
    {
        disconnect((QAbstractSocket*)socket,SIGNAL(disconnected()),
                this,SLOT(disconnection()));
        disconnect((QAbstractSocket*)socket,SIGNAL(readyRead()),
                this,SLOT(reading()));
    }
}
...
void TTcpServer::connection()
{
    ...
    while (hasPendingConnections())
    {
        ...
        connect((QAbstractSocket*)socket,SIGNAL(disconnected()),
                this,SLOT(disconnection()));
        connect((QAbstractSocket*)socket,SIGNAL(readyRead()),
                this,SLOT(reading()));
