    ...
    QApplication(argc,argv)
{
    ...
    connect(client,SIGNAL(recieve(QByteArray)),
            this,SLOT(fromModel(QByteArray)));
    interface = new TInterface();
    connect(interface,SIGNAL(sendModelParams(TParamData)),
            this,SLOT(sendModelParams(TParamData)));
    connect(interface,SIGNAL(paramRequest(EEvents,void*)),
            this,SLOT(toModel(EEvents,void*)));
    connect(interface,SIGNAL(stateRequest(EEvents,void*)),
            this,SLOT(toModel(EEvents,void*)));
