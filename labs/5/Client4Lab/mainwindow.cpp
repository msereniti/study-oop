...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(_connection, &ClientConnection::sigReceivedAnswer, this,
          &MainWindow::handlOnAnswerReceived);
}
...
void MainWindow::on_radioButton_clicked() { mode = 0; }

void MainWindow::on_radioButton_2_clicked() { mode = 1; }
